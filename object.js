...
// ```
// function getObjArr(arrObj) {
//     return arrObj.map(el => { el.age += 1; return el; });
// }
// ---
...
//   },
//   call(tryName) {
//     const tryContact = this.contacts.find(({ name }) => name === tryName);
//     console.log(`Call ${tryContact.number}`);
//   },
//   remove(name1) {
//     this.contacts = this.contacts.filter(({ name }) => name !== name1);
//   },
//   searchNAme(name2) {
//     const arrContacts = this.contacts.filter(({ name }) => name === name2);
...
console.log(rectangle.getArea(5, 10));
console.log(rectangle.getPermtr(6));
// ```
...
// };
// const C = 25;
// const F = temperatureConverter.getCToF(C);
// console.log(F);
// const C2 = temperatureConverter.getFToC(F);
// console.log(C2);

// Щоб перевести 25 градусів Цельсія у Фаренгейти: °F = (25 * 9/5) + 32 = 77°F.
// Щоб перевести 77 градусів Фаренгейта у Цельсії: °C = (77 - 32) * 5/9 = 25°C.
// ```
